...
public class FastestLap {
	...
	public FastestLap(String id, Integer year, String raceName, Integer lap, String lapTime, Integer milliseconds,
			String driverName) {
		super();
		this.id = id;
		this.year = year;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FastestLap other = (FastestLap) obj;
		if (driverName == null) {
	...
	public String toString() {
		return "FastestLap [id=" + id + ", year=" + year + ", raceName=" + raceName + ", lap=" + lap + ", lapTime="
